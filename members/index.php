...
<main class="members-container">
  ...
  <div class="sort-buttons">
    <a href="members/index.php?sort=furigana">50音順</a>
    <a href="members/index.php?sort=birth">誕生日順</a>
    <a href="members/index.php?sort=blood">血液型順</a>
    <a href="members/index.php?sort=height">身長順</a>
    <a href="members/index.php?sort=songs">参加楽曲数順</a>
    <a href="members/index.php?sort=titlesong">表題曲参加数順</a>
    <a href="members/index.php?sort=center">センター回数順</a>
    <a href="members/index.php">デフォルトに戻す</a>
  </div>
    ...
    if ($display_field) {
      ...
      if ($members) {
        ...
        foreach ($members as $rec) {
          ...
          echo '<a href="members/memberdetail.php?id=' . $rec['id'] . '">';
          if ($rec['image']) {
